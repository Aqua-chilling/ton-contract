...
Signature: `CreatePack{packId:int257,full_price:coins}`

## RemovePack
TLB: `remove_pack#d7b73b27 packId:int257 = RemovePack`
Signature: `RemovePack{packId:int257}`

## Withdraw
TLB: `withdraw#718f7bb2 amount:coins contract_jettonWallet:address = Withdraw`
Signature: `Withdraw{amount:coins,contract_jettonWallet:address}`
...
## UpdateJettonWallet
TLB: `update_jetton_wallet#8bfebb71 contract_jettonWallet:address = UpdateJettonWallet`
Signature: `UpdateJettonWallet{contract_jettonWallet:address}`

## BuyPack
TLB: `buy_pack#e57f6e6e queryId:uint64 packId:int257 response_destination:Maybe address amount:int257 = BuyPack`
Signature: `BuyPack{queryId:uint64,packId:int257,response_destination:Maybe address,amount:int257}`

## WithdrawnTon
TLB: `withdrawn_ton#1704739e amount:coins = WithdrawnTon`
Signature: `WithdrawnTon{amount:coins}`
